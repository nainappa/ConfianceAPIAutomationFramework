...
public class Executor {
  ...
  public static Responses doGetCall(String strEndPoint, Map<String, String> headers)
      throws Exception {
  ...
  public static Responses doPostCall(String strEndPoint, String strBody,
  ...
  public static Responses doDeleteCall(String strEndPoint, String strBody,
      Map<String, String> headers) throws Exception {
  ...
  public static <T> T doPostCallWithPojo(String strEndPoint,String strBody, Map<String, String> headers, Class<T> responsePojo)
      throws Exception {
    Responses response=doPostCall(strEndPoint, strBody, headers);
    return mapper.readValue(response.getBody().getBodyString(), responsePojo);
  }
  
  public static <T> T doPutCallWithPojo(String strEndPoint,String strBody, Map<String, String> headers, Class<T> responsePojo)
      throws Exception {
    Responses response=doPutCall(strEndPoint, strBody, headers);
    return mapper.readValue(response.getBody().getBodyString(), responsePojo);
  }
  
  public static <T> T doDeleteCallWithPojo(String strEndPoint,String strBody, Map<String, String> headers, Class<T> responsePojo)
      throws Exception {
